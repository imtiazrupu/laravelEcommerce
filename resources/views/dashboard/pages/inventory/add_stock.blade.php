        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-success" id="stock">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{ url('in-stock') }}" method="post" role="form"
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="subCategoryName">Entry Quantity</label>
                                        <input type="text" name="add_qty" v-model="entry" @change.once="onTotalSum" class="form-control" id="add_qty"
                                               placeholder="Entry Product Quantity">
                                        @if($errors->has('add_qty'))
                                            <div class="alert alert-danger">{{ $errors->first('add_qty') }}</div>
                                        @endif
                                    </div>
                                </div>
                                {{-- <div class="col-md-6">
