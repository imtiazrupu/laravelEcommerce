        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-success">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{ url('edit-classic-collections', ['id' => $classic->id ]) }}" role="form" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            ...
                            placeholder="Description">{{$classic->description}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" id="name"
                                       placeholder="Name" value="{{$classic->name}}">
                            </div>
                            <div class="form-group">

                                <label for="exampleInputFile">Default Photo</label>
                                <img width="300px" src="{{ url('storage/'. $classic->img) }}" alt="">
                                <input type="file" name="input_img" id="exampleInputFile">

                            </div>
                            <div class="form-group">
                                <label for="exampleInputFile">Image</label>
                                <img width="300px" src="{{ url('storage/'. $classic->img2) }}" alt="">
