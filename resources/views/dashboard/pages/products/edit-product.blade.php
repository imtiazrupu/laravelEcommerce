        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-success">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form name="editForm" action="{{ url('edit-product', ['id' => $product->id]) }}" method="post" role="form" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="box-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="item_no" class="form-control" id="itemNo"
                                               placeholder="Item No" value="{{ $product->item_no }}">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="versions" class="form-control" id="version"
                                               placeholder="Version" value="{{ $product->versions }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="collection" id="collection" value="{{ $product->collection }}">
                                        @if($errors->has('collection'))
                                            <div class="alert alert-danger">{{ $errors->first('collection') }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <table class="table table-bordered" id="dynamic_field">
                                    <tr>
                                        <td><input type="text" name="sizes[]" id="sizes" class="form-control" value="@foreach ($product->productSizes as $size) {{ $size->size }} @endforeach">
                                        <td>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                       <iframe width="300px" src="{{ url('storage/' . $product->pdf) }}" alt="{{ $product->name }}"> </iframe><br>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <img width="300px" src="{{ url('storage/' . $product->default_img) }}" alt="{{ $product->name }}"><br>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        @foreach ($product->productImages as $img)
                                            ...
                                            <img width="300px" src="{{ url('storage/' .$img->img) }}" alt="">
                                            @endforeach
                                            <br>
                ...
                <script type="text/javascript">
                    ...
                    document.forms['editForm'].elements['featured'].value="{{ $product->featured }}"
